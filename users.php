...
?>
          ...
          <form action="./php/insertarUsusario.php" class="row" method="POST">
            <div class="col-4">
              <label for="">Nombre</label>
              <input type="text" class="form-control" placeholder="Inserta tu nombre" name="nombre" id="txtnombre">
            </div>
            <div class="col-4">
              <label for="">Apellido</label>
              <input type="text" class="form-control" placeholder="Inserta tu apellido" name="ap">
            </div>
            <div class="col-4">
              <label for="">Email</label>
              <input type="email" class="form-control" placeholder="Inserta tu email" name="email">
            </div>
            <div class="col-4">
